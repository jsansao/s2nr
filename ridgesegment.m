...
%eixox = (1:681)*3/681;
%eixoy = (1:513)*11025/513;
%subplot(2,1,1), imagesc(eixox,eixoy,stddevim); axis xy; colormap(gray); ylabel('Freq (Hz)'); xlabel('Tempo(s)');
%subplot(2,1,2), imagesc(eixox,eixoy,mask); axis xy; colormap(gray); ylabel('Freq (Hz)'); xlabel('Tempo(s)');
%saveas(gcf, '/home/joao/desvio.eps', 'eps');
%pause;
